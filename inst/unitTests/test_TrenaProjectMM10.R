library(TrenaProjectMouseTCEx)
library(RUnit)
#------------------------------------------------------------------------------------------------------------------------
if(!exists("tProj")) {
   message(sprintf("--- creating instance of TrenaProjectMouseTCEx"))
   tProj <- TrenaProjectMouseTCEx();
   }
#------------------------------------------------------------------------------------------------------------------------
runTests <- function()
{
...
test_constructor <- function()
{
   ...
   checkTrue(all(c("TrenaProjectMouseTCEx", "TrenaProject") %in% is(tProj)))
